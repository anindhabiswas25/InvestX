...
async function main() {
  ...
  console.log("=== InvestX Smart Contract Deployment ===");
  ...
  console.log("\n--- Deploying InvestXEscrow ---");
  const Escrow = await hre.ethers.getContractFactory("InvestXEscrow");
  const escrow = await Escrow.deploy();
  await escrow.waitForDeployment();
  const escrowAddress = await escrow.getAddress();
  console.log("InvestXEscrow deployed to:", escrowAddress);
