...
const sendWelcomeEmail = (userEmail, userName) => {
  sendEmail(
    ...
    `<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:20px">
      <h1 style="color:#2563EB">Welcome to InvestX, ${userName}!</h1>
      <p>Thank you for joining InvestX — India's platform for fractional business investments.</p>
      <p>Next steps:</p>
      <ol>
      ...
      <p style="margin-top:24px;color:#6B7280;font-size:14px">— Team InvestX</p>
    </div>`
  );
};
...
const sendKYCApprovedEmail = (userEmail, userName) => {
  sendEmail(
    ...
    `<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:20px">
      ...
      <p>Hi ${userName},</p>
      <p>Your KYC verification has been approved. You can now invest in businesses on InvestX!</p>
...
const sendRefundEmail = (investorEmail, investorName, businessName, refundAmountXLM) => {
  sendEmail(
    ...
    `<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:20px">
      ...
      <p>We encourage you to explore other businesses on InvestX!</p>
