/**
 * InvestX Backend Integration Tests
 * -----------------------------------
 ...
 * Set INVESTX_TEST_TOKEN env var or edit the TOKEN constant below.
 */
...
const TOKEN = process.env.INVESTX_TEST_TOKEN || '';
...
async function runTests() {
  console.log('\n══════════════════════════════════════════════');
  console.log('  InvestX Backend Integration Tests');
  console.log('══════════════════════════════════════════════\n');
  ...
  if (!TOKEN) {
    console.log('\n⚠️  No INVESTX_TEST_TOKEN set — skipping authenticated tests');
    console.log('   Set env var INVESTX_TEST_TOKEN=<jwt> to run all tests.\n');
  }
