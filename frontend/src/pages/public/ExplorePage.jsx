                  ...
                  <div className="flex justify-center mt-10 gap-2">
                    {Array.from({ length: totalPages }, (_, i) => (
                      <button
                        ...
                        style={page === i + 1 ? { background: 'linear-gradient(135deg, #7C4DFF, #00C6FF)' } : {}}
                      >
                        {i + 1}
                      </button>
                    ))}
    ...
    >
      {checked && (
        <svg width="9" height="7" fill="none" viewBox="0 0 9 7">
          <path d="M1 3.5L3.5 6L8 1" stroke="#7C4DFF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      )}
    </div>
